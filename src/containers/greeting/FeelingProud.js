  ...
  render() {
    ...
    return (
      ...
      >
        ...
        />
        <g opacity=".1">
          <polygon points="737.92 589.5 692.8 558.3 697.97 564.75 737.92 592.38 738.88 605.82 748 606.3 747.83 603.41 738.88 602.94 737.92 589.5" />
          <polygon points="573.75 584.22 573.75 587.1 627.58 556.85 631.83 551.58 573.75 584.22" />
          <polygon points="561.75 651.9 561.75 654.78 573.27 654.78 573.08 651.9 561.75 651.9" />
          <polygon points="573.75 596.22 564.47 595.76 564.15 598.62 573.75 599.1 573.75 596.22" />
          <polygon points="750.88 659.11 748.96 642.78 663.51 545.82 653.43 544.86 572.31 637.02 572.48 639.71 653.43 547.74 663.51 548.7 748.96 645.66 750.88 661.99 762.4 662.47 762.07 659.57 750.88 659.11" />
        </g>
        <path
        ...
        <path
          ...
          transform="translate(-101.77 -35.91)"
        />
        <circle cx="335.45" cy="325.67" r="1.95" opacity=".1" />
        ...
        <path
          ...
          transform="translate(-101.77 -35.91)"
        />
        <circle cx="329.6" cy="232.54" r="1.95" opacity=".1" />
        <circle cx="329.6" cy="231.76" r="1.95" fill="#444053" />
        <circle cx="342.07" cy="354.9" r="1.95" opacity=".1" />
        <circle cx="342.07" cy="354.12" r="1.95" fill="#444053" />
        <circle cx="335.45" cy="387.24" r="1.95" opacity=".1" />
        ...
        <path
          ...
          transform="translate(-101.77 -35.91)"
        />
        <ellipse cx="472.21" cy="390.61" fill="#fff" rx="1.49" ry="2.98" />
        <path
          fill="#d1d9ec"
        ...
        {/* <rect
          ...
          fill="#d4dfec"
        /> */}
        {/* <rect width="43.81" height="11.52" x="880.49" y="809.92" opacity=".1" />
        <rect width="57.24" height="40.2" x="873.53" y="772.48" opacity=".1" />
        <rect
          width="43.81"
          height="11.52"
          x="883.37"
        ...
        <path
          ...
          transform="translate(-101.77 -35.91)"
        />
        {/* <circle cx="893.93" cy="724.35" r="1.44" opacity=".1" />
        <circle cx="893.81" cy="731.07" r="1.44" opacity=".1" />
        <circle cx="935.57" cy="725.67" r="1.44" opacity=".1" />
        <circle cx="901.97" cy="760.12" r="1.44" opacity=".1" />
        <circle cx="932.57" cy="736.83" r="1.44" opacity=".1" />
        <circle cx="917.69" cy="751.72" r="1.44" opacity=".1" />
        <circle cx="898.85" cy="727.23" r="1.44" opacity=".1" />
        <circle cx="931.61" cy="729.99" r="1.44" opacity=".1" />
        <circle cx="926.69" cy="741.15" r="1.44" opacity=".1" />
        <circle cx="911.57" cy="759.04" r="1.44" opacity=".1" />
        <circle cx="908.45" cy="751.96" r="1.44" opacity=".1" />
        <circle cx="901.01" cy="735.99" r="1.44" opacity=".1" /> */}
        {/* <rect width="43.81" height="4.21" x="883.37" y="809.92" opacity="0" />
        <rect
          width="57.24"
          height="40.2"
          x="876.41"
          ...
          fill={theme.body}
        /> */}
        {/* <circle cx="913.49" cy="765.52" r="1.44" opacity=".1" />
        <circle cx="904.85" cy="767.32" r="1.44" opacity=".1" /> */}
      </svg>
    );
  }
}
